        ...
        $cq_signup_html = '
                    <div class="cq-container">
                        <form id="newsletter_form" class="newsletter-form" action="' . get_site_url() . '/wp-admin/admin-ajax.php" method="POST">
                            ...
                            <button class="button button-orange sc-button-medium newsletter_submit" type="submit" id="newsletter_submit"><span class="hidden-md-down">Submit</span> <i class="fa fa-angle-right fa-lg"></i></button>
                        </form>
