...
?>
<div class="digital-issue-item col_2">
    ...
    <a href="<?php echo esc_url( $link ); ?>" target="' . esc_attr($target) . '" class="button-orange button di-read" style="margin: 0;display: block;text-align: center;position: absolute;">READ NOW</a>
</div>