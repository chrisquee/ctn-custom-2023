...
jQuery(document).ready(function($){
  ...
  $("input[type=checkbox][value=Print]").next(".wpcf7-list-item-label").append(' <a href="#" data-toggle="tooltip" data-placement="right" title="You will receive four issues a year."><i class="fa fa-question-circle"></i></a>');
  $("input[type=checkbox][value=Digital]").next(".wpcf7-list-item-label").append(' <a href="#" data-toggle="tooltip" data-placement="right" title="You will receive four issues a year straight to your inbox."><i class="fa fa-question-circle"></i></a>');
  $("input[type=checkbox][value=Newsletter]").next(".wpcf7-list-item-label").append(' <a href="#" data-toggle="tooltip" data-placement="right" title="A fortnightly summary of the latest news straight to your inbox."><i class="fa fa-question-circle"></i></a>');
